package com.ais.middleware.policy.issuance.observability;
...
public class EDAFlowProcessor implements Processor {
    ...
    @Value("${spring.application.name:policy-issuance-service}")
    ...
    private static final Map<String, String> TOPIC_TO_PUBLISHER = Map.ofEntries(
            ...
            Map.entry("compliance.commands.request-compliance-check", "PolicyIssuance"),
    ...
    private static final Map<String, String> TOPIC_TO_CONSUMER = Map.ofEntries(
            ...
            Map.entry("policy.events.policy-issued", "Notification"),
            Map.entry("policy.events.issuance-failed", "PolicyIssuance"),
            ...
            Map.entry("compliance.commands.request-compliance-check", "Compliance"),
    ...
    private static final Map<String, String> TOPIC_TO_MESSAGE_TYPE = Map.ofEntries(
            ...
            Map.entry("compliance.commands.request-compliance-check", "RequestComplianceCheckCommand"),
